...
public class PoCJWEApplication {
    ...
    public static void main(String[] args) throws InvalidKeyException {
        ...
        // AES
        String aesJwe = encryptFieldAESKEK(samplePayload, aesKek);
        System.out.println("AES JWE = " + aesJwe);
        String decryptedAesJwe = decryptJweAes(aesJwe, aesKek);
        System.out.println("AES JWE decrypted = " + decryptedAesJwe);
        // AES

        // RSA
        String rsaJwe = encryptFieldRSA(samplePayload, publicKey);
    ...
    private static String decryptJweAes(String aesJwe, String key) {
        try {
    ...
    public static String encryptFieldAESKEK(String str, String key) {
        try {
            byte[] keyBytes = key.getBytes();
            SecretKey originalKey = new SecretKeySpec(keyBytes, 0, keyBytes.length, "AES");
